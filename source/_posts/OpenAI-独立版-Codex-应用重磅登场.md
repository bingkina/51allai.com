...
description: "OpenAI 正式发布 Codex 独立桌面应用，内置工作区支持多智能体后台并行处理不同模块、项目级深层上下文感知跨文件逻辑推理、自定义 Skills 封装将框架开发规范转化为 AI 技能，开发者角色从与AI对话式代码补全转向任务委派式异步协作。"
date: 2026-02-03 22:10:28
categories: 智能体
tags: [openai, codex, product-update]
---
