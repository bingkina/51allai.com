...
categories: 大模型
tags: [deepseek, deepseek-v4, open-source, model-release]
description: "DeepSeek 推出总参1.6万亿参数的 V4-Pro 与 2840亿参数的 V4-Flash 预览版，混合注意力机制使1M上下文推理 FLOPs 降至上一代27%、KV Cache 占用骤降10%，内置独立最大化推理模式，核心代码能力直指闭源第一梯队。"
